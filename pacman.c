    ...
    for(int i = 0; i < MAP_SIZE_H; i++) {
        for(int j = 0; j < MAP_SIZE_W; j++) {
            ...
            case EntityHorizontalWall:
                canvas_draw_icon(
                    canvas, j * HORIZONTAL_MARGIN, i * VERTICAL_MARGIN, &I_horizontal_wall_4x4);
                break;
            case EntityVerticalWall:
                canvas_draw_icon(
                    canvas, j * HORIZONTAL_MARGIN, i * VERTICAL_MARGIN, &I_vertical_wall_4x4);
                break;
            case EntityBottomLeftWall:
                canvas_draw_icon(
                    canvas, j * HORIZONTAL_MARGIN, i * VERTICAL_MARGIN, &I_bottomleft_wall_4x4);
                break;
            case EntityBottomRightWall:
                canvas_draw_icon(
                    canvas, j * HORIZONTAL_MARGIN, i * VERTICAL_MARGIN, &I_bottomright_wall_4x4);
                break;
            case EntityTopLeftWall:
                canvas_draw_icon(
                    canvas, j * HORIZONTAL_MARGIN, i * VERTICAL_MARGIN, &I_topleft_wall_4x4);
                break;
            case EntityTopRightWall:
                canvas_draw_icon(
                    canvas, j * HORIZONTAL_MARGIN, i * VERTICAL_MARGIN, &I_topright_wall_4x4);
                break;
            default:
                break;
            }

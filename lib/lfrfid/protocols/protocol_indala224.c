...
static bool protocol_indala224_check_preamble(uint8_t* data, size_t bit_index) {
    ...
    if(( data[        bit_index / 8] & 0xFE ) != 0b10000000) return false;
...
static bool protocol_indala224_can_be_decoded(uint8_t* data) {
    ...
    if(!protocol_indala224_check_preamble(data, 224)) return false;
    return true;
}
...
bool protocol_indala224_write_data(ProtocolIndala224* protocol, void* data) {
    ...
    if(request->write_type == LFRFIDWriteTypeT5577) {
        ...
        request->t5577.block[3] = bit_lib_get_bits_32(protocol->encoded_data, 32, 32);
        request->t5577.block[4] = bit_lib_get_bits_32(protocol->encoded_data, 32, 32);
        request->t5577.block[5] = bit_lib_get_bits_32(protocol->encoded_data, 32, 32);
        request->t5577.block[6] = bit_lib_get_bits_32(protocol->encoded_data, 32, 32);
        request->t5577.block[7] = bit_lib_get_bits_32(protocol->encoded_data, 32, 32);

 ...
 * @return SubGhzProtocolEncoderDickertMAHS* pointer to a SubGhzProtocolEncoderDickertMAHS instance
 */
 ...
 * @param environment Pointer to a SubGhzEnvironment instance
 * @return SubGhzProtocolDecoderDickertMAHS* pointer to a SubGhzProtocolDecoderDickertMAHS instance
 */

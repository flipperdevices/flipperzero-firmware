...
static void mf_ultralight_mirror_read_prepare(uint8_t start_page, MfUltralightListener* instance) {
...
static void mf_ultralight_mirror_read_handler(
...
static void mf_ultraligt_mirror_prepare_emulation(MfUltralightListener* instance) {

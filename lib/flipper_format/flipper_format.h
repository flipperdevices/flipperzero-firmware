 ...
 *     
 *     if(!flipper_format_file_open_new(format, STORAGE_EXT_PATH_PREFIX "/flipper_format_test")) break;
 ...
 *     
 *     if(!flipper_format_file_open_existing(file, STORAGE_EXT_PATH_PREFIX "/flipper_format_test")) break;

    ...
    try:
        with serial.Serial(port_name, baud_rate) as ser:
            ...
            if tempo_override is not None:
                ...
                new_tempo = int(original_tempo * (midi_file.ticks_per_beat / (tempo_override * midi_file.ticks_per_beat / 60)))
            ...
            for msg in midi_file.play():
                if msg.type == 'note_on' or msg.type == 'note_off':
                    ...
                    if msg.type == 'note_on':
                        ...
                        print(f"Sent message: {msg.type}, {[hex(b) for b in midi_bytes]}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Convert MIDI file to serial messages and send them to a serial port.")
    ...
    parser.add_argument("-b", "--baud", type=int, default=31250, help="Baud rate (default: 31250)")

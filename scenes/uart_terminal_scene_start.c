...
const UART_TerminalItem items[NUM_MENU_ITEMS] = {
    ...
    6,
    {"beacon", "beacon target-ssids", "beacon ap", "beacon rickroll", "beacon random ", "beacon infinite", "beacon off"},
    TOGGLE_ARGS,
    FOCUS_CONSOLE_END,
    NO_TIP},
    {"Probe",
    ...
    NO_TIP},
    {"Get",
    {"PACKET_EXPIRY", "SSID_LEN_MIN", "SSID_LEN_MAX", "DEFAULT_SSID_COUNT", "Channel", "MAC", "MAC_RAND"},
    7,
    {"get expiry", "get ssid_len_min", "get ssid_len_max", "get default_ssid_count", "get channel", "get mac", "get mac_rand"},
    NO_ARGS,
    FOCUS_CONSOLE_END,
    NO_TIP},
    {"Set",
    {"PACKET_EXPIRY", "ATTACK_MILLIS", "SSID_LEN_MIN", "SSID_LEN_MAX", "DEFAULT_SSID_COUNT", "Channel", "MAC", "MAC_RAND"},
    8,
    {"set expiry ", "set attack_millis ", "set ssid_len_min ", "set ssid_len_max ", "set default_ssid_count ", "set channel ", "set mac ", "set mac_rand "},
    INPUT_ARGS,
    FOCUS_CONSOLE_END,
    NO_TIP},
    {"Deauth",

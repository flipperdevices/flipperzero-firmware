...
static void gravity_scene_attacks_mana_var_list_change_callback(VariableItem* item) {
    ...
    const GravityItem* menu_item = &attacks_mana[app->selected_menu_items[GRAVITY_MENU_ATTACKS_MANA]];
...
void gravity_scene_attacks_mana_on_enter(void* context) {
    ...
    variable_item_list_set_selected_item(var_item_list, app->selected_menu_items[GRAVITY_MENU_ATTACKS_MANA]);

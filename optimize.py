...
print("Original, 1/4:")
data_array_orig=list(range(1,simulated_size))+([0]*simulated_size)
new_end_orig=extend_table_original(data_array_orig, 0, simulated_size-1, 1)
a=set(data_array_orig)
print(sorted(a))

print("New, 1/4:")
data_array_new=list(range(1,simulated_size))+([0]*(simulated_size-9))
new_end_new=extend_table_new(data_array_new, 0, simulated_size-1, 1)

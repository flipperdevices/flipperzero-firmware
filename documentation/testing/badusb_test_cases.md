...
1. Connect the flipper to the Mac and open Bad usb app
   **Expected result**
     1. A list of scripts for all platforms is displayed

2. Make sure that the layout is EN
3. Run demo script for Mac
   **Expected result**
     1. The script started and executed on the PC
...
6. Run the qFlipper download script
   **Expected result**
     1. The command line has started with the process of downloading the qFlipper, after which the application will
        start

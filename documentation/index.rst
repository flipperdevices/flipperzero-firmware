...
Aside from the manually-written documentation files, there's also an auto-generated documentation section, which contains the reference to the structures and APIs of the firmware. It is generated from the source code, and are useful for quickly finding the source code or API documentation for a particular function or data structure.

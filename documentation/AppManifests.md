...
- **fap_file_assets**: directory name to be used for gathering files to be included in the `.fap` file. These files will be extracted by application loader to `/assets/` virtual folder before starting the application. See `applications/examples/example_apps_assets` for details.

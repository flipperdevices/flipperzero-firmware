...
## Instruction
1. Read [How to build](https://github.com/RogueMaster/flipperzero-firmware/blob/420/documentation/HowToBuild.md) and [How to install](https://github.com/RogueMaster/flipperzero-firmware/blob/420/documentation/HowToInstall.md) to know how to build and install firmware

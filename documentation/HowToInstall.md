...
## [Get Latest Firmware from GitHub Releases](https://github.com/pieceofsys/flipperzero-firmware/releases)
...
- Open latest release page - [Releases](https://github.com/pieceofsys/flipperzero-firmware/releases/latest)
...
- ## [Read instructions how to use plugins and more](https://github.com/pieceofsys/flipperzero-firmware#instructions)

- ## [How To: Configure Sub-GHz Remote App](https://github.com/pieceofsys/flipperzero-firmware/blob/dev/documentation/SubGHzRemotePlugin.md)

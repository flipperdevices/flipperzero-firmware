...
void color_guess_scene_menu_on_enter(void* context) {
    ...
    submenu_add_item(app->submenu, "Play Game", SubmenuIndexPlay, color_guess_scene_menu_submenu_callback, app);
    submenu_add_item(app->submenu, "Set Color", SubmenuIndexColorSet, color_guess_scene_menu_submenu_callback, app);
    submenu_add_item(app->submenu, "Settings", SubmenuIndexSettings, color_guess_scene_menu_submenu_callback, app);

    submenu_set_selected_item(app->submenu, scene_manager_get_scene_state(app->scene_manager, ColorGuessSceneMenu));

...
const BubbleAnimation BA_L1_BadBattery_128x47 = {.icon_animation = {.width=128,.height=49,.frame_count=2,.frame_rate=2,.frames=_A_L1_BadBattery_128x47}, .frame_order={0, 1}, .passive_frames = 2, .duration = 3600, .frame_bubble_sequence = L1_BadBattery_bubbles, .frame_bubble_sequence_count = COUNT_OF(L1_BadBattery_bubbles)};
...
const BubbleAnimation BA_L1_NoSd_128x49 = {.icon_animation = {.width=128,.height=49,.frame_count=6,.frame_rate=2,.frames=_A_L1_NoSd_128x49}, .frame_order={0, 1, 0, 1, 0, 2, 3, 4, 3, 5}, .passive_frames = 10, .duration = 3600, .frame_bubble_sequence = L1_NoSd_bubbles, .frame_bubble_sequence_count = COUNT_OF(L1_NoSd_bubbles)};

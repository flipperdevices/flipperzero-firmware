...
typedef struct _PB_Main { 
    ...
    union {
        ...
        PB_System_BackupCreateRequest system_backup_create_request;
        PB_System_BackupRestoreRequest system_backup_restore_request;
    } content; 
} PB_Main;
...
#define PB_Main_system_backup_create_request_tag 42
#define PB_Main_system_backup_restore_request_tag 43
...
X(a, STATIC,   ONEOF,    MSG_W_CB, (content,system_backup_create_request,content.system_backup_create_request),  42) \
X(a, STATIC,   ONEOF,    MSG_W_CB, (content,system_backup_restore_request,content.system_backup_restore_request),  43)
...
#define PB_Main_content_system_backup_create_request_MSGTYPE PB_System_BackupCreateRequest
#define PB_Main_content_system_backup_restore_request_MSGTYPE PB_System_BackupRestoreRequest

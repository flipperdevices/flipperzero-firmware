...
class Assets:
    def __init__(self):
        ...
        self.parser_icons = self.subparsers.add_parser('icons', help='Process icons and build icon registry')
        self.parser_icons.add_argument("-s","--source-directory", help="Source directory")
        self.parser_icons.add_argument("-o", "--output-directory", help="Output directory")
    ...
    def icons(self):
        ...
        for dirpath, dirnames, filenames in os.walk(self.args.source_directory):
            ...
            if 'frame_rate' in filenames:
                ...
                icons_c.write(ICONS_TEMPLATE_C_DATA.format(name=f"_{icon_name}", data=f'{{{",".join(frame_names)}}}'))
                icons_c.write("\n")
                ...
                for filename in filenames:
                    ...
                    icons_c.write(ICONS_TEMPLATE_C_FRAME.format(name=frame_name, data=data))
                    icons_c.write(ICONS_TEMPLATE_C_DATA.format(name=f"_{icon_name}", data=f'{{{frame_name}}}'))
                    icons_c.write("\n")
        ...
        for name, width, height, frame_rate, frame_count in icons:
            icons_c.write(ICONS_TEMPLATE_C_ICONS_ITEM.format(
                name=name, width=width, height=height, frame_rate=frame_rate, frame_count=frame_count
            ))

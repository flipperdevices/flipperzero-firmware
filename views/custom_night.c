...
void draw_custom_night_menu(Canvas* canvas, void* ctx) {
    ...
    // arrows
    canvas_draw_line(canvas, 78, 19 + fnaf->custom_menu_cursor * 11, 76, 21 + fnaf->custom_menu_cursor * 11);
    canvas_draw_line(canvas, 76, 21 + fnaf->custom_menu_cursor * 11, 78, 23 + fnaf->custom_menu_cursor * 11);
    canvas_draw_line(canvas, 94, 19 + fnaf->custom_menu_cursor * 11, 96, 21 + fnaf->custom_menu_cursor * 11);
    canvas_draw_line(canvas, 96, 21 + fnaf->custom_menu_cursor * 11, 94, 23 + fnaf->custom_menu_cursor * 11);
}

...
void nextStrata(){
    ...
    currentStratagem = &groups[groupIndex].stratagems[strataIndex];
}
...
void nextLevel(){
    ...
    levelCompleted = 0;
    totaltime -= ((float)totaltime * 0.25);
    remainingtime = totaltime;

    groupIndex = furi_hal_random_get() % 6;
...
static void handleKeyPress(InputKey key){
    ...
    if(fail){
        remainingtime -= ((float)totaltime * 0.10);;
        arrowIndex = 0;
    }

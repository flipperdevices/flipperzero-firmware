...
Topic symmetric_cipher[] = {
    {"1-Blowfish", NULL, APP_ASSETS_PATH("development.txt")},
...
Chapter chapters[] = {
    ...
    {"5-Authentication Codes", authentication_codes, sizeof(authentication_codes) / sizeof(Topic)},
    {"6-Hash Functions", hash_functions, sizeof(hash_functions) / sizeof(Topic)},

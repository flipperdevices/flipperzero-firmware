...
# zip -rq "RC-RM$DATE_VAR-$TIME_VAR-$VER_VAR-$HASH_VAR.zip" "RM$DATE_VAR-$TIME_VAR"
# tar -czf "RC-RM$DATE_VAR-$TIME_VAR-$VER_VAR-$HASH_VAR.tgz" "RM$DATE_VAR-$TIME_VAR"
...
./fbt updater_package
mv dist/f7-C/f7-update-RM420FAP "RC-RM$DATE_VAR-$TIME_VAR"
...
tar -cf "../../../RC-RM$DATE_VAR-$TIME_VAR/resources.tar" *
cd ../../../
zip -rq "RC-RM$DATE_VAR-$TIME_VAR-$VER_VAR-$HASH_VAR.zip" "RC-RM$DATE_VAR-$TIME_VAR"
tar -czf "RC-RM$DATE_VAR-$TIME_VAR-$VER_VAR-$HASH_VAR.tgz" "RC-RM$DATE_VAR-$TIME_VAR"
rm -rf "RC-RM$DATE_VAR-$TIME_VAR"
rm -rf assets/dolphin/internal/*
git stash

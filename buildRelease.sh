...
zip -r "RM$TIME_VAR-$DATE_VAR-$HASH_VAR-$VER_VAR.zip" "$VER_VAR-$DATE_VAR-RM$TIME_VAR"
tar -czvf "RM$TIME_VAR-$DATE_VAR-$HASH_VAR-$VER_VAR.tgz" "$VER_VAR-$DATE_VAR-RM$TIME_VAR"

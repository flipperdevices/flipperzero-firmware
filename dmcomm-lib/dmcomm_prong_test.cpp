...
ProngTester::ProngTester(BaseProngOutput& output, BaseProngInput& input) :
    output_(&output), input_(&input), analog_input_(nullptr) {}

ProngTester::ProngTester(BaseProngOutput& output, BaseProngInput& input, AnalogProngInput& analog_input) :
    output_(&output), input_(&input), analog_input_(&analog_input) {}

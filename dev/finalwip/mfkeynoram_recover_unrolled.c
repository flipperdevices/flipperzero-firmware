...
int recover(struct Crypto1Params *p, int ks2) {
    ...
    int *odd = extend_table_precompute(e_head, &o_tail, oks, 15, CONST_M1_1, CONST_M2_1);
    int *even = extend_table_precompute(e_head, &e_tail, eks, 15, CONST_M1_2, CONST_M2_2);

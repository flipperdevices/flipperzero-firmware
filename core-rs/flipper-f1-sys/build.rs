...
impl BindingsGenerator {
    ...
    pub fn generate_cmsis_os_bindings(&self) {
        ...
        let builder = self.builder()
            ...
            .whitelist_type("osStatus_t")
            .rustified_enum("osStatus_t")

            .whitelist_type("osThreadId_t")
            .whitelist_type("osThreadFunc_t")
            .whitelist_type("TZ_ModuleId_t")
            .whitelist_type("osThreadAttr_t")
            .whitelist_type("osPriority_t")
            .rustified_enum("osPriority_t")
            .whitelist_function("osThreadNew")
            .whitelist_function("osThreadGetId")
            .whitelist_function("osThreadTerminate")
            .whitelist_function("osThreadYield")

            .whitelist_type("osMutexId_t")
            .whitelist_type("osMutexAttr_t")
            .whitelist_function("osMutexNew")
            .whitelist_function("osMutexAcquire")
            .whitelist_function("osMutexRelease")
            .whitelist_function("osMutexGetOwner")
            .whitelist_function("osMutexDelete")

            .whitelist_type("osSemaphoreId_t")
            .whitelist_type("osSemaphoreAttr_t")
            .whitelist_function("osSemaphoreNew")
            .whitelist_function("osSemaphoreAcquire")
            .whitelist_function("osSemaphoreRelease")
            .whitelist_function("osSemaphoreGetCount")
            .whitelist_function("osSemaphoreDelete")

            .whitelist_type("osMessageQueueId_t")
            .whitelist_type("osMessageQueueAttr_t")
            .whitelist_function("osMessageQueueNew")
            .whitelist_function("osMessageQueuePut")
            .whitelist_function("osMessageQueueGet")

            .whitelist_var("osWaitForever")
            .whitelist_function("osDelay")

            .whitelist_function("osKernelGetTickFreq")
            .whitelist_function("osKernelGetSysTimerFreq")
        ;

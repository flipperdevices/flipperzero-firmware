...
const Icon I_Chess_Selection1 = {.width=8,.height=8,.frame_count=1,.frame_rate=0,.frames=_I_Chess_Selection1};
const Icon I_Chess = {.width=128,.height=64,.frame_count=1,.frame_rate=0,.frames=_I_Chess};
const Icon I_Chess_kb = {.width=6,.height=6,.frame_count=1,.frame_rate=0,.frames=_I_Chess_kb};
const Icon I_Chess_rw = {.width=6,.height=6,.frame_count=1,.frame_rate=0,.frames=_I_Chess_rw};
const Icon I_Chess_rb = {.width=6,.height=6,.frame_count=1,.frame_rate=0,.frames=_I_Chess_rb};
const Icon I_Chess_kw = {.width=6,.height=6,.frame_count=1,.frame_rate=0,.frames=_I_Chess_kw};
const Icon I_Chess_qb = {.width=6,.height=6,.frame_count=1,.frame_rate=0,.frames=_I_Chess_qb};
const Icon I_Chess_qw = {.width=6,.height=6,.frame_count=1,.frame_rate=0,.frames=_I_Chess_qw};
const Icon I_Chess_pw = {.width=6,.height=6,.frame_count=1,.frame_rate=0,.frames=_I_Chess_pw};
const Icon I_Chess_pb = {.width=6,.height=6,.frame_count=1,.frame_rate=0,.frames=_I_Chess_pb};
const Icon I_Chess_nb = {.width=6,.height=6,.frame_count=1,.frame_rate=0,.frames=_I_Chess_nb};
const Icon I_Chess_bw = {.width=6,.height=6,.frame_count=1,.frame_rate=0,.frames=_I_Chess_bw};
const Icon I_Chess_bb = {.width=6,.height=6,.frame_count=1,.frame_rate=0,.frames=_I_Chess_bb};
const Icon I_Chess_nw = {.width=6,.height=6,.frame_count=1,.frame_rate=0,.frames=_I_Chess_nw};

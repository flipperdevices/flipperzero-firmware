...
APP_IBUTTON_TEST ?= 0
ifeq ($(APP_IBUTTON_TEST), 1)
CFLAGS		+= -DAPP_IBUTTON_TEST
BUILD_IBUTTON_TEST = 1
endif
BUILD_IBUTTON_TEST ?= 0
ifeq ($(BUILD_IBUTTON_TEST), 1)
CFLAGS		+= -DBUILD_IBUTTON_TEST
CPP_SOURCES	+= $(wildcard $(APP_DIR)/ibutton-test/*.cpp)
endif

...
APP_DOLPHIN_SCENES ?= 0
ifeq ($(APP_DOLPHIN_SCENES), 1)
CFLAGS		+= -DAPP_DOLPHIN_SCENES
BUILD_DOLPHIN_SCENES = 1
endif
BUILD_DOLPHIN_SCENES ?= 0
ifeq ($(BUILD_DOLPHIN_SCENES), 1)
CFLAGS		+= -DBUILD_DOLPHIN_SCENES
C_SOURCES	+= $(wildcard $(APP_DIR)/dolphin_scenes/*.c)
endif

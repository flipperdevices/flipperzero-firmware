...
void lfrfid_scene_wipe_t5577_confirm_on_enter(void* context) {
    ...
    dialog_message_set_header(message, "This will delete all T5577 user blocks data.", 0, 0, AlignLeft, AlignTop);
    dialog_message_set_buttons(message, NULL, NULL, "Yes");
    dialog_message_set_text(message, "Are you sure?", SCREEN_WIDTH_CENTER,

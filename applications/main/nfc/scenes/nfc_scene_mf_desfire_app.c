    ...
    if(event.type == SceneManagerEventTypeCustom) {
        if(event.event == NfcCustomEventViewExit) {
            ...
            if(event.event == SubmenuIndexAppInfo) {
                ...
                nfc_mf_desfire_render_application_id(app_id, nfc->text_box_store);
                nfc_mf_desfire_render_application(app, nfc->text_box_store);
            } else {
                ...
                nfc_mf_desfire_render_file_id(file_id, nfc->text_box_store);
                nfc_mf_desfire_render_file_settings_data(

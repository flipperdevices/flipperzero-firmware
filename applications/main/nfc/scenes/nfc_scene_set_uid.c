...
void nfc_scene_set_uid_byte_input_changed_callback(void* context) {
...
void nfc_scene_set_uid_byte_input_done_callback(void* context) {
    NfcApp* instance = context;
...
void nfc_scene_set_uid_on_enter(void* context) {
    ...
    byte_input_set_result_callback(
        byte_input,
        nfc_scene_set_uid_byte_input_done_callback,

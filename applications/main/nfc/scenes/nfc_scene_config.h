...
ADD_SCENE(nfc, mf_ultralight_write_initial, MfUltralightWriteInitial)
ADD_SCENE(nfc, mf_ultralight_write_initial_success, MfUltralightWriteSuccess)
ADD_SCENE(nfc, mf_ultralight_write_initial_fail, MfUltralightWriteFail)

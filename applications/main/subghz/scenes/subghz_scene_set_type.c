...
bool subghz_scene_set_type_on_event(void* context, SceneManagerEvent event) {
    ...
    if(event.type == SceneManagerEventTypeCustom) {
        ...
        case SubmenuIndexDoorHan_433_92:
            generated_protocol = subghz_gen_keelog_protocol(
        ...
        case SubmenuIndexSecPlus_v2_310_00:
            generated_protocol =
                subghz_gen_secplus_v2_protocol(subghz->txrx, "AM650", 310000000, key, 0x68, 0xE500000);
            break;
        case SubmenuIndexSecPlus_v2_315_00:
            generated_protocol =
                subghz_gen_secplus_v2_protocol(subghz->txrx, "AM650", 315000000, key, 0x68, 0xE500000);
            break;
        case SubmenuIndexSecPlus_v2_390_00:
            generated_protocol =
                subghz_gen_secplus_v2_protocol(subghz->txrx, "AM650", 390000000, key, 0x68, 0xE500000);
            break;
        default:
            return false;
            break;

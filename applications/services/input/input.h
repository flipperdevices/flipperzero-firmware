...
typedef enum {
    ...
    InputTypeLong, /**< Long event, emitted after INPUT_LONG_PRESS interval, asynchronous to InputTypeRelease  */
    InputTypeRepeat, /**< Repeat event, emitted with INPUT_REPEAT_PRESS period after InputTypeLong event */

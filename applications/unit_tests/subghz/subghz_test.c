...
#define KEYSTORE_DIR_NAME STORAGE_EXT_PATH_PREFIX "/subghz/assets/keeloq_mfcodes"
#define CAME_ATOMO_DIR_NAME STORAGE_EXT_PATH_PREFIX "/subghz/assets/came_atomo"
#define NICE_FLOR_S_DIR_NAME STORAGE_EXT_PATH_PREFIX "/subghz/assets/nice_flor_s"
#define TEST_RANDOM_DIR_NAME STORAGE_EXT_PATH_PREFIX "/unit_tests/subghz/test_random_raw.sub"
...
MU_TEST(subghz_decoder_came_atomo_test) {
    mu_assert(
        subghz_decoder_test(
            STORAGE_EXT_PATH_PREFIX "/unit_tests/subghz/came_atomo_raw.sub",
...
MU_TEST(subghz_decoder_came_test) {
    mu_assert(
        subghz_decoder_test(
            STORAGE_EXT_PATH_PREFIX "/unit_tests/subghz/came_raw.sub", SUBGHZ_PROTOCOL_CAME_NAME),
...
MU_TEST(subghz_decoder_came_twee_test) {
    mu_assert(
        subghz_decoder_test(
            STORAGE_EXT_PATH_PREFIX "/unit_tests/subghz/came_twee_raw.sub",
...
MU_TEST(subghz_decoder_faac_slh_test) {
    mu_assert(
        subghz_decoder_test(
            STORAGE_EXT_PATH_PREFIX "/unit_tests/subghz/faac_slh_raw.sub",
...
MU_TEST(subghz_decoder_gate_tx_test) {
    mu_assert(
        subghz_decoder_test(
            STORAGE_EXT_PATH_PREFIX "/unit_tests/subghz/gate_tx_raw.sub",
...
MU_TEST(subghz_decoder_hormann_hsm_test) {
    mu_assert(
        subghz_decoder_test(
            STORAGE_EXT_PATH_PREFIX "/unit_tests/subghz/hormann_hsm_raw.sub",
...
MU_TEST(subghz_decoder_ido_test) {
    mu_assert(
        subghz_decoder_test(
            STORAGE_EXT_PATH_PREFIX "/unit_tests/subghz/ido_117_111_raw.sub",
...
MU_TEST(subghz_decoder_keelog_test) {
    mu_assert(
        subghz_decoder_test(
            STORAGE_EXT_PATH_PREFIX "/unit_tests/subghz/doorhan_raw.sub",
...
MU_TEST(subghz_decoder_kia_seed_test) {
    mu_assert(
        subghz_decoder_test(
            STORAGE_EXT_PATH_PREFIX "/unit_tests/subghz/kia_seed_raw.sub",
            SUBGHZ_PROTOCOL_KIA_NAME),
...
MU_TEST(subghz_decoder_nero_radio_test) {
    mu_assert(
        subghz_decoder_test(
            STORAGE_EXT_PATH_PREFIX "/unit_tests/subghz/nero_radio_raw.sub",
...
MU_TEST(subghz_decoder_nero_sketch_test) {
    mu_assert(
        subghz_decoder_test(
            STORAGE_EXT_PATH_PREFIX "/unit_tests/subghz/nero_sketch_raw.sub",
...
MU_TEST(subghz_decoder_nice_flo_test) {
    mu_assert(
        subghz_decoder_test(
            STORAGE_EXT_PATH_PREFIX "/unit_tests/subghz/nice_flo_raw.sub",
...
MU_TEST(subghz_decoder_nice_flor_s_test) {
    mu_assert(
        subghz_decoder_test(
            STORAGE_EXT_PATH_PREFIX "/unit_tests/subghz/nice_flor_s_raw.sub",
...
MU_TEST(subghz_decoder_princeton_test) {
    mu_assert(
        subghz_decoder_test(
            STORAGE_EXT_PATH_PREFIX "/unit_tests/subghz/Princeton_raw.sub",
...
MU_TEST(subghz_decoder_scher_khan_magic_code_test) {
    mu_assert(
        subghz_decoder_test(
            STORAGE_EXT_PATH_PREFIX "/unit_tests/subghz/scher_khan_magic_code.sub",
...
MU_TEST(subghz_decoder_somfy_keytis_test) {
    mu_assert(
        subghz_decoder_test(
            STORAGE_EXT_PATH_PREFIX "/unit_tests/subghz/Somfy_keytis_raw.sub",
...
MU_TEST(subghz_decoder_somfy_telis_test) {
    mu_assert(
        subghz_decoder_test(
            STORAGE_EXT_PATH_PREFIX "/unit_tests/subghz/somfy_telis_raw.sub",
...
MU_TEST(subghz_decoder_star_line_test) {
    mu_assert(
        subghz_decoder_test(
            STORAGE_EXT_PATH_PREFIX "/unit_tests/subghz/cenmax_raw.sub",
...
MU_TEST(subghz_decoder_linear_test) {
    mu_assert(
        subghz_decoder_test(
            STORAGE_EXT_PATH_PREFIX "/unit_tests/subghz/linear_raw.sub",
...
MU_TEST(subghz_decoder_megacode_test) {
    mu_assert(
        subghz_decoder_test(
            STORAGE_EXT_PATH_PREFIX "/unit_tests/subghz/megacode_raw.sub",
...
MU_TEST(subghz_decoder_secplus_v1_test) {
    mu_assert(
        subghz_decoder_test(
            STORAGE_EXT_PATH_PREFIX "/unit_tests/subghz/security_pls_1_0_raw.sub",
...
MU_TEST(subghz_decoder_secplus_v2_test) {
    mu_assert(
        subghz_decoder_test(
            STORAGE_EXT_PATH_PREFIX "/unit_tests/subghz/security_pls_2_0_raw.sub",
...
MU_TEST(subghz_decoder_holtek_test) {
    mu_assert(
        subghz_decoder_test(
            STORAGE_EXT_PATH_PREFIX "/unit_tests/subghz/holtek_raw.sub",
...
MU_TEST(subghz_decoder_power_smart_test) {
    mu_assert(
        subghz_decoder_test(
            STORAGE_EXT_PATH_PREFIX "/unit_tests/subghz/power_smart_raw.sub",

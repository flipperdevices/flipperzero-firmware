...
MU_TEST(subghz_decoder_firefly_test) {
    mu_assert(
        subghz_decode_test("/ext/unit_tests/subghz/firefly_raw.sub", SUBGHZ_PROTOCOL_FIREFLY_NAME),
...
MU_TEST(subghz_ecoder_firefly_test) {
    mu_assert(
        subghz_ecode_test("/ext/unit_tests/subghz/firely.sub"),
        "Test encoder " SUBGHZ_PROTOCOL_FIREFLY_NAME " error\r\n");
}

MU_TEST(subghz_ecoder_megacode_test) {
    mu_assert(
        subghz_ecode_test("/ext/unit_tests/subghz/megacode.sub"),
...
MU_TEST_SUITE(subghz) {
    ...
    MU_RUN_TEST(subghz_ecoder_firefly_test);
    MU_RUN_TEST(subghz_ecoder_megacode_test);

...
ADD_SCENE(nfc, mf_ultralight_read_auth_info, MfUltralightReadAuthInfo)
ADD_SCENE(nfc, mf_ultralight_auth, MfUltralightAuth)
ADD_SCENE(nfc, mf_ultralight_auth_warn, MfUltralightAuthWarning)

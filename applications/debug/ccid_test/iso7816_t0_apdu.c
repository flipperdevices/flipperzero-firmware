...
void iso7816_read_command_apdu(struct ISO7816_Command_APDU * command, const uint8_t *dataBuffer, uint32_t dataLen) {
...
void iso7816_write_response_apdu(const struct ISO7816_Response_APDU * response, uint8_t *dataBuffer, uint32_t *dataLen) {

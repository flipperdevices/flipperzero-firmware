...
bool test_furi_event_loop_producer_callback(FuriEventLoopBase* object, void* context) {
    furi_check(context);

    TestFuriData* data = context;
    furi_check(data->mq == (FuriMessageQueue*)object, "Invalid queue");
...
int32_t test_furi_event_loop_producer(void* p) {
    ...
    furi_event_loop_unsubscribe(data->producer_event_loop, (FuriEventLoopBase*)data->mq);
...
bool test_furi_event_loop_consumer_callback(FuriEventLoopBase* object, void* context) {
    furi_check(context);

    TestFuriData* data = context;
    furi_check(data->mq == (FuriMessageQueue*)object);
...
int32_t test_furi_event_loop_consumer(void* p) {
    ...
    furi_event_loop_unsubscribe(data->consumer_event_loop, (FuriEventLoopBase*)data->mq);

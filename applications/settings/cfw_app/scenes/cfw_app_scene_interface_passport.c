...
const char* const image_text[PROFILE_IMG_COUNT] = {
    "None",       "AD Police",       "Briareos",
    "Cobra",      "Dali Mask",       "DEDSEC",
    "Deer",       "Dolphin (Happy)", "Dolphin (Moody)",
    "ED-209",     "FSociety",        "FSociety 2",
    "Goku (Set)", "Goku (Kid)",      "Goku (Adult)",
    "Goku (SSJ)", "Goku (SSJ3)",     "Guy Fawkes",
    "Lain",       "Mario",           "Marvin",
    "Moreleeloo", "Neuromancer",     "Pikachu (Sleepy)",
    "Rabbit",     "Shinkai",         "Skull",
    "Slime",      "Sonic",           "Spider Jerusalem",
    "Tank Girl",  "Totoro",          "Waifu 1",
    "Waifu 2",    "Waifu 3",         "Wrench"};
...
const uint32_t image_value[PROFILE_IMG_COUNT] = {
    ...
    PIMG_MARVIN,   PIMG_MORELEELLOO, PIMG_NEUROMANCER, PIMG_PIKASLEEPY,   PIMG_RABBIT,
    PIMG_SHINKAI,  PIMG_SKULL,       PIMG_SLIME,       PIMG_SONIC,        PIMG_SPIDER,
    PIMG_TANKGIRL, PIMG_TOTORO,      PIMG_WAIFU1,      PIMG_WAIFU2,       PIMG_WAIFU3,
    PIMG_WRENCH};

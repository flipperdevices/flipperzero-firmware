...
const uint32_t image_value[PROFILE_IMG_COUNT] = {
    PIMG_NONE,        PIMG_ADPOLICE,    PIMG_BRIAREOS,     PIMG_DALI,    PIMG_DEDSEC,
    ...
    PIMG_GUYFAWKES,   PIMG_LAIN,        PIMG_LEEROY,       PIMG_MARIO,   PIMG_MARVIN,
    PIMG_MORELEELLOO, PIMG_NEUROMANCER, PIMG_PIKASLEEPY,   PIMG_PIRATE,  PIMG_RABBIT,
    PIMG_SCARMLA,     PIMG_SCCOBRA,     PIMG_SCCRYBO,      PIMG_SCDOMRO, PIMG_SCSANDRA,
    PIMG_SCTARBEIGE,  PIMG_SHINKAI,     PIMG_SKULL,        PIMG_SLIME,   PIMG_SONIC,

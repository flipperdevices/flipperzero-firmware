...
void bt_settings_scene_forget_dev_confirm_on_enter(void* context) {
    ...
    dialog_ex_set_header(dialog, i18n("Unpair All Devices?"), 64, 0, AlignCenter, AlignTop);
    dialog_ex_set_text(
        dialog, i18n("All previous pairings\nwill be lost!"), 64, 14, AlignCenter, AlignTop);
    dialog_ex_set_left_button_text(dialog, i18n("Cancel"));
    dialog_ex_set_right_button_text(dialog, i18n("Unpair"));

...
bool esp_flasher_scene_quick_on_event(void* context, SceneManagerEvent event) {
    ...
    if(event.type == SceneManagerEventTypeCustom) {
        ...
        case QuickWifidevS2Marauder:
            ...
            firm = APP_DATA_PATH("assets/marauder/WifidevS2/esp32_marauder_v0_13_6_20231214_flipper.bin");
            enter_bootloader = true;
            break;
        case QuickDevproWroomMarauder:
            ...
            app0 = APP_DATA_PATH("assets/marauder/boot_app0.bin");
            firm = APP_DATA_PATH(
                "assets/marauder/DevproWroom/esp32_marauder_v0_13_6_20231214_marauder_dev_board_pro.bin");
            break;
        default:
            flash = false;
            consumed = false;

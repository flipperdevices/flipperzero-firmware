...
/** Sets selected_item_x and selected_item_y to a given value.
 * 
 * @param      button_panel  ButtonPanel instance
 * @param      x             column index
 * @param      y             row index
 */
void button_panel_set_selection(ButtonPanel* button_panel, uint16_t x, uint16_t y);

/** Gets selected_item_x and selected_item_y.
 * 
 * @param      button_panel  ButtonPanel instance
 * @param      x             column index
 * @param      y             row index

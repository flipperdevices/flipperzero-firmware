...
void note_main_menu_on_enter( void * context ){
    ...
    submenu_add_item(app->submenu, " Add new note ", Notes_Main_menu_Add_Item, notes_main_menu_callback, app); 
    submenu_add_item(app->submenu, " List your notes ", Notes_Main_menu_List_Item, notes_main_menu_callback, app); 
...
void (* const notes_scene_on_enter_handlers[])(void*) = {
    note_main_menu_on_enter,
    note_text_input_on_enter,
    note_list_of_notes_on_enter
};
...
void (* const notes_scene_on_leave_handlers[])(void*) = {
    note_main_menu_on_leave,
    note_text_input_on_leave,
    note_list_of_notes_on_leave
};

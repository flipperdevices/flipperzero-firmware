...
const WifiMarauderItem items[NUM_MENU_ITEMS] = {
    ...
    {"Clear List",
     ...
     NO_TIP},
    {"Attack",
     {"deauth", "probe", "rickroll", "sour apple", "swiftpair spam", "samsung spam", "bt spam all"},
     7,
     {"attack -t deauth", "attack -t probe", "attack -t rickroll", "sourapple", "swiftpair", "samsungblespam", "btspamall"},
     NO_ARGS,
     FOCUS_CONSOLE_END,
     SHOW_STOPSCAN_TIP},
    {"Wardrive",

...
UHF_RFID_CMD CMD_GET_SELECT_PARAMETER = {
    .cmd = (uint8_t[]){0xBB, 0x00, 0x0B, 0x00, 0x00, 0x0B, 0x7E},
    .length = 7};

UHF_RFID_CMD CMD_SET_SELECT_MODE = {
    .cmd = (uint8_t[]){0xBB, 0x00, 0x12, 0x00, 0x01, 0x01, 0x14, 0x7E},
    .length = 8};

UHF_RFID_CMD CMD_READ_LABEL_DATA_STORAGE = {
    .cmd =
        (uint8_t[]){
            0xBB,
            0x00,
...
UHF_RFID_CMD CMD_BLOCK_PERMALOCK = {
    .cmd =
        (uint8_t[]){
            0xBB,
            0x00,

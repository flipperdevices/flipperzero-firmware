...
ADD_SCENE(nfc_magic, wipe_check, WipeCheck)
ADD_SCENE(nfc_magic, wipe_fail, WipeFail)
ADD_SCENE(nfc_magic, check_gen4, CheckGen4)
ADD_SCENE(nfc_magic, check_gen4_fail, CheckGen4Fail)
ADD_SCENE(nfc_magic, file_not_supported, FileNotSupported)
...
static void select_stats_render_callback(Canvas* canvas, void* context) {
    ...
    if(current_index == 0) {
        canvas_draw_str_aligned(canvas, 55, 54 / 2, AlignLeft, AlignTop, "Random IV");
        canvas_draw_str_aligned(canvas, 55, 38, AlignLeft, AlignTop, "Zero EV");
    } else if(current_index == 1) {
        canvas_draw_str_aligned(canvas, 55, 54 / 2, AlignLeft, AlignTop, "Random IV");
        canvas_draw_str_aligned(canvas, 55, 38, AlignLeft, AlignTop, "Max EV / Lvl");
    } else if(current_index == 2) {
        canvas_draw_str_aligned(canvas, 55, 54 / 2, AlignLeft, AlignTop, "Random IV");
        canvas_draw_str_aligned(canvas, 55, 38, AlignLeft, AlignTop, "Max EV");
    } else if(current_index == 3) {
        canvas_draw_str_aligned(canvas, 55, 54 / 2, AlignLeft, AlignTop, "Max IV");
        canvas_draw_str_aligned(canvas, 55, 38, AlignLeft, AlignTop, "Zero EV");

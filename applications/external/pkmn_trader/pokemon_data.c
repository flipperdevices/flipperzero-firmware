...
const char* stat_text[] = {
    "ATK",    "DEF",          "SPD",     "SPC_ATK", "SPC_DEF",      "HP",         "Type",  "Move",
    "Growth", "Gender Ratio", "ATK_EV",  "DEF_EV",  "SPD_EV",       "SPC_EV",     "HP_EV", "IV",
    "ATK_IV", "DEF_IV",       "SPD_IV",  "SPC_IV",  "HP_IV",        "Lvl.",       "Idx.",  "Num.",
    "Cond.",  "Nick.",        "OT Name", "OT ID",   "Trainer Name", "EV/IV Sel.", "Exp.",
};

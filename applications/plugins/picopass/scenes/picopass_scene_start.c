...
bool picopass_scene_start_on_event(void* context, SceneManagerEvent event) {
    ...
    if(event.type == SceneManagerEventTypeCustom) {
	    ...
	    scene_manager_set_scene_state(picopass->scene_manager, PicopassSceneStart, SubmenuIndexRead);
	    ...
	    scene_manager_set_scene_state(picopass->scene_manager, PicopassSceneStart, SubmenuIndexSaved);

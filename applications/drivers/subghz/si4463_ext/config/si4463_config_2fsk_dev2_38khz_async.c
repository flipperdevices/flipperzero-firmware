...
// MOD_type: 2    Rsymb(sps): 4800    Fdev(Hz): 2380    RXBW(Hz): 150000    Manchester: 0    AFC_en: 0    Rsymb_error: 0.0    Chip-Version: 2    
...
// # WB filter 4 (BW =  44.07 kHz);  NB-filter 4 (BW = 44.07 kHz)
// 
// Modulation index: 0,992
*/
...
//   MODEM_FREQ_DEV_1 - 17-bit unsigned TX frequency deviation word.
*/
#define RF_MODEM_MOD_TYPE_12_1 0x11, 0x20, 0x0C, 0x00, 0x2A, 0x00, 0x07, 0x00, 0xBB, 0x80, 0x01, 0xE8, 0x48, 0x00, 0x00, 0x00
...
//   MODEM_FREQ_DEV_0 - 17-bit unsigned TX frequency deviation word.
*/
#define RF_MODEM_FREQ_DEV_0_1_1 0x11, 0x20, 0x01, 0x0C, 0x9C
...
//   MODEM_BCR_OSR_0 - RX BCR/Slicer oversampling rate (12-bit unsigned number).
*/
#define RF_MODEM_TX_RAMP_DELAY_12_1 0x11, 0x20, 0x0C, 0x18, 0x01, 0x80, 0x08, 0x03, 0x80, 0x00, 0x30, 0x20, 0x0C, 0xE8, 0x01, 0xA1
...
//   MODEM_AFC_GAIN_0 - Sets the gain of the PLL-based AFC acquisition loop, and provides miscellaneous control bits for AFC functionality.
*/
#define RF_MODEM_BCR_NCO_OFFSET_2_12_1 0x11, 0x20, 0x0C, 0x24, 0x01, 0x3A, 0x93, 0x00, 0x9D, 0x00, 0xC2, 0x00, 0x54, 0x23, 0x80, 0xAB
...
//   MODEM_AFC_MISC - Specifies miscellaneous AFC control bits.
*/
#define RF_MODEM_AFC_LIMITER_1_3_1 0x11, 0x20, 0x03, 0x30, 0x01, 0xD9, 0x80
...
//   MODEM_OOK_MISC - Selects the detector(s) used for demodulation of an OOK signal, or for demodulation of a (G)FSK signal when using the asynchronous demodulator.
*/
#define RF_MODEM_AGC_WINDOW_SIZE_12_1 0x11, 0x20, 0x0C, 0x38, 0x11, 0x5B, 0x5B, 0x80, 0x02, 0x3F, 0x77, 0x00, 0x2A, 0x0C, 0x84, 0x23
...
//   MODEM_RSSI_COMP - RSSI compensation value.
*/
#define RF_MODEM_RAW_CONTROL_10 0x11, 0x20, 0x0A, 0x45, 0x8F, 0x00, 0x4C, 0x01, 0x00, 0xE0, 0x06, 0x00, 0x18, 0x40
...
const uint8_t subghz_device_si4463_preset_2fsk_dev2_38khz_async_regs[] = RADIO_CONFIGURATION_DATA_ARRAY;
...
// MOD_type: 1    Rsymb(sps): 4800    Fdev(Hz): 48000    RXBW(Hz): 263000    Manchester: 0    AFC_en: 0    Rsymb_error: 0.0    Chip-Version: 2    
...
// # WB filter 3 (BW = 263.43 kHz);  NB-filter 3 (BW = 263.43 kHz)
// 
// Modulation index: 20
*/
...
//   MODEM_FREQ_DEV_1 - 17-bit unsigned TX frequency deviation word.
*/
#define RF_MODEM_MOD_TYPE_12_1 0x11, 0x20, 0x0C, 0x00, 0x29, 0x00, 0x07, 0x00, 0xBB, 0x80, 0x01, 0xE8, 0x48, 0x00, 0x00, 0x00
...
//   MODEM_BCR_OSR_0 - RX BCR/Slicer oversampling rate (12-bit unsigned number).
*/
#define RF_MODEM_TX_RAMP_DELAY_12_1 0x11, 0x20, 0x0C, 0x18, 0x00, 0x80, 0x08, 0x03, 0x80, 0x00, 0x0A, 0x10, 0x0C, 0xE8, 0x00, 0x45
...
//   MODEM_AFC_GAIN_0 - Sets the gain of the PLL-based AFC acquisition loop, and provides miscellaneous control bits for AFC functionality.
*/
#define RF_MODEM_BCR_NCO_OFFSET_2_12_1 0x11, 0x20, 0x0C, 0x24, 0x07, 0x5F, 0x70, 0x03, 0xB6, 0x00, 0xC2, 0x00, 0x54, 0x23, 0x00, 0x27
...
//   MODEM_AFC_MISC - Specifies miscellaneous AFC control bits.
*/
#define RF_MODEM_AFC_LIMITER_1_3_1 0x11, 0x20, 0x03, 0x30, 0x22, 0x9E, 0x80
...
//   MODEM_OOK_MISC - Selects the detector(s) used for demodulation of an OOK signal, or for demodulation of a (G)FSK signal when using the asynchronous demodulator.
*/
#define RF_MODEM_AGC_WINDOW_SIZE_12_1 0x11, 0x20, 0x0C, 0x38, 0x11, 0x0F, 0x0F, 0x80, 0x02, 0xFF, 0xFF, 0x00, 0x28, 0x0C, 0x84, 0x21
...
//   MODEM_RSSI_COMP - RSSI compensation value.
*/
#define RF_MODEM_RAW_CONTROL_10 0x11, 0x20, 0x0A, 0x45, 0x8E, 0x07, 0xFF, 0x01, 0x00, 0xE0, 0x06, 0x00, 0x18, 0x40
...
//   MODEM_DSA_MISC - Miscellaneous detection of signal arrival bits.
*/
#define RF_MODEM_DSA_CTRL1_5_1 0x11, 0x20, 0x05, 0x5B, 0x40, 0x04, 0x11, 0x78, 0x20
...
const uint8_t subghz_device_si4463_preset_ook_270khz_async_regs[] = RADIO_CONFIGURATION_DATA_ARRAY;
...
#include "subghz_device_si4463_ext_config.h"
...
static volatile SubGhzState subghz_device_si4463_ext_state = SubGhzStateInit;
static volatile SubGhzRegulation subghz_device_si4463_ext_regulation = SubGhzRegulationTxRx;
static volatile FuriHalSubGhzPreset subghz_device_si4463_ext_preset = FuriHalSubGhzPresetIDLE;
...
void subghz_device_si4463_ext_init() {
    furi_assert(subghz_device_si4463_ext_state == SubGhzStateInit);
    ...
    furi_hal_gpio_init(&SUBGHZ_DEVICE_SI4463_EXT_TX_GPIO, GpioModeOutputPushPull, GpioPullNo, GpioSpeedLow);
#endif

    subghz_device_si4463_ext_load_config(subghz_device_si4463_ext_preset_ook_650khz_async_regs);
...
void subghz_device_si4463_ext_load_preset(FuriHalSubGhzPreset preset) {
    ...
    case FuriHalSubGhzPresetOok270Async:
        subghz_device_si4463_ext_load_config(subghz_device_si4463_ext_preset_ook_270khz_async_regs);
        subghz_device_si4463_ext_mod_gpio_for_async(SI446X_MODEM_MOD_TYPE_MOD_TYPE_OOK);
        break;
    case FuriHalSubGhzPreset2FSKDev238Async:
        subghz_device_si4463_ext_load_config(subghz_device_si4463_ext_preset_2fsk_dev2_38khz_async_regs);
        subghz_device_si4463_ext_mod_gpio_for_async(SI446X_MODEM_MOD_TYPE_MOD_TYPE_2FSK);
        break;
    case FuriHalSubGhzPreset2FSKDev476Async:
        subghz_device_si4463_ext_load_config(subghz_device_si4463_ext_preset_2fsk_dev4_76khz_async_regs);
        subghz_device_si4463_ext_mod_gpio_for_async(SI446X_MODEM_MOD_TYPE_MOD_TYPE_2FSK);
        break;
    case FuriHalSubGhzPresetOok650AsyncFreq:
        subghz_device_si4463_ext_load_config(subghz_device_si4463_ext_preset_ook_650khz_async_for_freq_regs);
        //subghz_device_si4463_ext_load_config(subghz_device_si4463_ext_preset_ook_650khz_async_regs);
        //subghz_device_si4463_ext_mod_gpio_for_async(SI446X_MODEM_MOD_TYPE_MOD_TYPE_OOK);
        break;
...
void subghz_device_si4463_ext_shutdown() {
    ...
    subghz_device_si4463_ext_preset = FuriHalSubGhzPresetIDLE;
    subghz_device_si4463_ext_state = SubGhzStateInit;
}
...
uint32_t subghz_device_si4463_ext_set_frequency_and_path(uint32_t value) {
    ...
    if(value >= 299999755 && value <= 348000335) {
        subghz_device_si4463_ext_set_path(FuriHalSubGhzPath315);
    } else if(value >= 386999938 && value <= 464000000) {
        subghz_device_si4463_ext_set_path(FuriHalSubGhzPath433);
    } else if(value >= 778999847 && value <= 928000000) {
        subghz_device_si4463_ext_set_path(FuriHalSubGhzPath868);
    } else {
        furi_crash(NULL);
    }
    return value;
        ...
        if(!(value >= 304100000 && value <= 321950000) &&
           ...
           !(value >= 915000000 && value <= 928000000)) {
            ...
            if(furi_hal_rtc_is_flag_set(FuriHalRtcFlagDebug)) {
                if((value >= 304100000 && value <= 321950000) &&
                   ((subghz_device_si4463_ext_preset == FuriHalSubGhzPresetOok270Async) ||
                    (subghz_device_si4463_ext_preset == FuriHalSubGhzPresetOok650Async))) {
...
uint32_t subghz_device_si4463_ext_set_frequency(uint32_t value) {
    if(subghz_device_si4463_ext_is_tx_allowed(value)) {
        subghz_device_si4463_ext_regulation = SubGhzRegulationTxRx;
    } else {
        subghz_device_si4463_ext_regulation = SubGhzRegulationOnlyRx;
    }
...
static void subghz_device_si4463_ext_async_tx_refill(uint32_t* buffer, size_t samples) {
    while(samples > 0) {
        ...
        LevelDuration ld =
            subghz_device_si4463_ext_async_tx.callback(subghz_device_si4463_ext_async_tx.callback_context);
        ...
        if(level_duration_is_wait(ld)) {
            ...
            if(is_odd == level) {
                *buffer = API_HAL_SUBGHZ_ASYNC_TX_GUARD_TIME;
                ...
                samples--;
                if(!level) {
                    subghz_device_si4463_ext_async_tx.duty_high += API_HAL_SUBGHZ_ASYNC_TX_GUARD_TIME;
                } else {
                    subghz_device_si4463_ext_async_tx.duty_low += API_HAL_SUBGHZ_ASYNC_TX_GUARD_TIME;
                }
            }
...
bool subghz_device_si4463_ext_start_async_tx(FuriHalSubGhzAsyncTxCallback callback, void* context) {
    ...
    furi_hal_interrupt_set_isr(FuriHalInterruptIdDma1Ch1, subghz_device_si4463_ext_async_tx_dma_isr, NULL);
    ...
    furi_hal_interrupt_set_isr(FuriHalInterruptIdTIM2, subghz_device_si4463_ext_async_tx_timer_isr, NULL);
...
void subghz_device_si4463_ext_stop_async_tx() {
    ...
    float duty_cycle =
        100.0f * (float)subghz_device_si4463_ext_async_tx.duty_high /
        ((float)subghz_device_si4463_ext_async_tx.duty_low + (float)subghz_device_si4463_ext_async_tx.duty_high);
    FURI_LOG_D(
        TAG,

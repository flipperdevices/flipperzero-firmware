...
static void ibutton_scene_emulate_callback(void* context, bool emulated) {
    ...
    if(emulated) {
        view_dispatcher_send_custom_event(ibutton->view_dispatcher, iButtonCustomEventWorkerEmulated);
    }
}
...
void ibutton_scene_emulate_on_enter(void* context) {
    ...
    ibutton_worker_emulate_set_callback(ibutton->key_worker, ibutton_scene_emulate_callback, ibutton);

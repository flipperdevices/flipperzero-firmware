...
void LfrfidSceneRead::on_enter(LfrfidApp* app) {
    LfrfidAppViewManager* view_manager = app->get_view_manager();

    Popup* popup = view_manager->get_popup();
    popup_set_header(popup, "LF-RFID read", 64, 16, AlignCenter, AlignBottom);
...
bool LfrfidSceneRead::on_event(LfrfidApp* app, LfrfidEvent* event) {
    bool consumed = false;
...
void LfrfidSceneRead::on_exit(LfrfidApp* app) {
    LfrfidAppViewManager* view_manager = app->get_view_manager();

...
GameResult_t calculate_game_result(RPSApp_t* app) {
    ...
    if (
        (app->user_hand == HandTypeScissor && app->system_hand == HandTypePaper) ||
...
void rpselements_hand_box(Canvas* canvas, int x, int y, HandType_t hand, HandBoxType_t hand_box_type) {

...
#ifndef PB_PB_SYSTEM_FLIPPERZERO_PROTOBUF_SYSTEM_PB_H_INCLUDED
#define PB_PB_SYSTEM_FLIPPERZERO_PROTOBUF_SYSTEM_PB_H_INCLUDED
#include <pb.h>
...
#define PB_SYSTEM_FLIPPERZERO_PROTOBUF_SYSTEM_PB_H_MAX_SIZE PB_System_GetDateTimeResponse_size

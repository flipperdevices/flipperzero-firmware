# Flipper Application Files (FAPs) for [Unleashed](https://github.com/DarkFlippers/unleashed-firmware) and [OFW](https://github.com/flipperdevices/flipperzero-firmware) with API v19.x
## Apps from this pack should be compatible with OFW with API v19.x (dev branch)
...
### Apps checked & updated at `21 Mar 18:25 GMT +3`

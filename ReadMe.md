# Flipper Application Files (FAPs) for Any Firmware with API v24.x
## Apps from this pack should be compatible with OFW with API v24.x (dev branch) or any other firmware build with API 24.x
...
### Apps checked & updated at `5 May 03:28 GMT +3`

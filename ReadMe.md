...
- [Fixed many memory leaks (By RogueMaster)]() with thanks to [Fixed memory leak #13 (By squee72564)](https://github.com/leedave/flipper-zero-fap-boilerplate/pull/13)

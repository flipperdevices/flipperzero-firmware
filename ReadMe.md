...
- Updated: [BLE Spam v2.0 (By Willy-JL & ECTO-1A & Spooks4576 with research from xMasterX; OFW API thanks to noproto)](https://github.com/noproto/ble_spam_ofw) - Removed the popups from the list that had no class & OFW friendly fonts, thanks noproto!

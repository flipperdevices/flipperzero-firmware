...
class TestIbuttonBench(BaseCase):
    def test_cyfral(self, nav_reader, nav_key, relay):
        ...
        with allure.step("Reading original key by reader_flipper"):
            ...
            nav_reader.press_ok()
            assert nav_reader.wait_for_state("key_Cyfral_bench", timeout = 5) == 0, "Reading reference key failed"
        with allure.step("Reading emulated key by reader_flipper"):
            relay.set_key(8)
            time.sleep(0.1)
            nav_reader.press_left()
            nav_reader.press_left()
            assert nav_reader.wait_for_state("key_Cyfral_bench", timeout = 5) == 0, "Reading emulated key failed"
    ...
    def test_metakom(self, nav_reader, nav_key, relay):
        ...
        with allure.step("Emulating key on key_flipper"):
            if nav_key.open_file("iButton", "BI1") == -1:
                ...
                relay.set_reader(2)
                nav_key.press_ok()
                assert nav_key.wait_for_state("key_Metakom_bench", timeout = 5) == 0, "No reference key"
                time.sleep(0.1)
                nav_key.press_right()
                nav_key.go_to("Save")
                nav_key.press_ok()
        ...
        with allure.step("Reading original key by reader_flipper"):
            ...
            nav_reader.go_to("Read")
            nav_reader.press_ok()
            assert nav_reader.wait_for_state("key_Metakom_bench", timeout = 5) == 0, "Reading reference key failed"
        with allure.step("Reading emulated key by reader_flipper"):
            relay.set_key(8)
            time.sleep(0.1)
            nav_reader.press_left()
            nav_reader.press_left()
            assert nav_reader.wait_for_state("key_Metakom_bench", timeout = 5) == 0, "Reading emulated key failed"
        with allure.step("Cheking key menu"):
            nav_reader.press_right()
            menu = nav_reader.get_menu_list()
            menu_ref = [
    ...
    def test_ds1992(self, nav_reader, nav_key, relay):
        ...
        with allure.step("Emulating key on key_flipper"):
            if nav_key.open_file("iButton", "BI2") == -1:
                ...
                relay.set_reader(2)
                nav_key.press_ok()
                assert nav_key.wait_for_state("key_DS1992_bench", timeout = 5) == 0, "No reference key"
                time.sleep(0.1)
                nav_key.press_right()
                nav_key.go_to("Save")
                nav_key.press_ok()
        ...
        with allure.step("Reading original key by reader_flipper"):
            ...
            nav_reader.go_to("Read")
            nav_reader.press_ok()
            assert nav_reader.wait_for_state("key_DS1992_bench", timeout = 5) == 0, "Reading reference key failed"
        with allure.step("Reading emulated key by reader_flipper"):
            relay.set_key(8)
            time.sleep(0.1)
            nav_reader.press_left()
            nav_reader.press_left()
            assert nav_reader.wait_for_state("key_DS1992_bench", timeout = 5) == 0, "Reading emulated key failed"
        with allure.step("Cheking key menu"):
            nav_reader.press_right()
            menu = nav_reader.get_menu_list()
            menu_ref = [
    ...
    def test_ds1996(self, nav_reader, nav_key, relay):
        ...
        with allure.step("Emulating key on key_flipper"):
            if nav_key.open_file("iButton", "BI3") == -1:
                ...
                relay.set_reader(2)
                nav_key.press_ok()
                assert nav_key.wait_for_state("key_DS1996_bench", timeout = 5) == 0, "No reference key"
                time.sleep(0.1)
                nav_key.press_right()
                nav_key.go_to("Save")
                nav_key.press_ok()
        ...
        with allure.step("Reading original key by reader_flipper"):
            ...
            nav_reader.go_to("Read")
            nav_reader.press_ok()
            assert nav_reader.wait_for_state("key_DS1996_bench", timeout = 5) == 0, "Reading reference key failed"
        with allure.step("Reading emulated key by reader_flipper"):
            relay.set_key(8)
            time.sleep(0.1)
            nav_reader.press_left()
            nav_reader.press_left()
            assert nav_reader.wait_for_state("key_DS1996_bench", timeout = 5) == 0, "Reading emulated key failed"
        with allure.step("Cheking key menu"):
            nav_reader.press_right()
            menu = nav_reader.get_menu_list()
            menu_ref = [
    ...
    def test_ds1971(self, nav_reader, nav_key, relay):
        ...
        with allure.step("Emulating key on key_flipper"):
            if nav_key.open_file("iButton", "BI4") == -1:
                ...
                relay.set_reader(2)
                nav_key.press_ok()
                assert nav_key.wait_for_state("key_DS1971_bench", timeout = 5) == 0, "No reference key"
                time.sleep(0.1)
                nav_key.press_right()
                nav_key.go_to("Save")
                nav_key.press_ok()
        ...
        with allure.step("Reading original key by reader_flipper"):
            ...
            nav_reader.go_to("Read")
            nav_reader.press_ok()
            assert nav_reader.wait_for_state("key_DS1971_bench", timeout = 5) == 0, "Reading reference key failed"
        with allure.step("Reading emulated key by reader_flipper"):
            relay.set_key(8)
            time.sleep(0.1)
            nav_reader.press_left()
            nav_reader.press_left()
            assert nav_reader.wait_for_state("key_DS1971_bench", timeout = 5) == 0, "Reading emulated key failed"
        with allure.step("Cheking key menu"):
            nav_reader.press_right()
            menu = nav_reader.get_menu_list()
            menu_ref = [

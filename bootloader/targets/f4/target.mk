...
CFLAGS			+= $(MCU_FLAGS) $(BOOT_CFLAGS) -DSTM32WB55xx -Wall -fdata-sections -ffunction-sections -fstack-protector -fstack-clash-protection -fstack-protector-all -fstack-protector-strong

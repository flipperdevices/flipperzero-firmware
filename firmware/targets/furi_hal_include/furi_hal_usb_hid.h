...
/** HID keyboard key codes HU */
enum HidKeyboardKeysHU {
    HID_KEYBOARD_HU_A = HID_KEYBOARD_A,
    HID_KEYBOARD_HU_B = HID_KEYBOARD_B,
    HID_KEYBOARD_HU_C = HID_KEYBOARD_C,
    HID_KEYBOARD_HU_D = HID_KEYBOARD_D,
    HID_KEYBOARD_HU_E = HID_KEYBOARD_E,
    HID_KEYBOARD_HU_F = HID_KEYBOARD_F,
    HID_KEYBOARD_HU_G = HID_KEYBOARD_G,
    HID_KEYBOARD_HU_H = HID_KEYBOARD_H,
    HID_KEYBOARD_HU_I = HID_KEYBOARD_I,
    HID_KEYBOARD_HU_J = HID_KEYBOARD_J,
    HID_KEYBOARD_HU_K = HID_KEYBOARD_K,
    HID_KEYBOARD_HU_L = HID_KEYBOARD_L,
    HID_KEYBOARD_HU_M = HID_KEYBOARD_M,
    HID_KEYBOARD_HU_N = HID_KEYBOARD_N,
    HID_KEYBOARD_HU_O = HID_KEYBOARD_O,
    HID_KEYBOARD_HU_P = HID_KEYBOARD_P,
    HID_KEYBOARD_HU_Q = HID_KEYBOARD_Q,
    HID_KEYBOARD_HU_R = HID_KEYBOARD_R,
    HID_KEYBOARD_HU_S = HID_KEYBOARD_S,
    HID_KEYBOARD_HU_T = HID_KEYBOARD_T,
    HID_KEYBOARD_HU_U = HID_KEYBOARD_U,
    HID_KEYBOARD_HU_V = HID_KEYBOARD_V,
    HID_KEYBOARD_HU_W = HID_KEYBOARD_W,
    HID_KEYBOARD_HU_X = HID_KEYBOARD_X,
    HID_KEYBOARD_HU_Y = HID_KEYBOARD_Z,
    HID_KEYBOARD_HU_Z = HID_KEYBOARD_Y,

    HID_KEYBOARD_HU_1 = HID_KEYBOARD_1,
    HID_KEYBOARD_HU_2 = HID_KEYBOARD_2,
    HID_KEYBOARD_HU_3 = HID_KEYBOARD_3,
    HID_KEYBOARD_HU_4 = HID_KEYBOARD_4,
    HID_KEYBOARD_HU_5 = HID_KEYBOARD_5,
    HID_KEYBOARD_HU_6 = HID_KEYBOARD_6,
    HID_KEYBOARD_HU_7 = HID_KEYBOARD_7,
    HID_KEYBOARD_HU_8 = HID_KEYBOARD_8,
    HID_KEYBOARD_HU_9 = HID_KEYBOARD_9,
    HID_KEYBOARD_HU_0 = HID_KEYBOARD_GRAVE_ACCENT,

    HID_KEYBOARD_HU_DOUBLE_ACUTE_SHORT_O = HID_KEYBOARD_0,
    HID_KEYBOARD_HU_DOUBLE_ACUTE_SHORT_U = HID_KEYBOARD_MINUS,
    HID_KEYBOARD_HU_ACUTE_A = HID_KEYBOARD_APOSTROPHE,
    HID_KEYBOARD_HU_ACUTE_O = HID_KEYBOARD_EQUAL_SIGN,
    HID_KEYBOARD_HU_ACCENT_E = HID_KEYBOARD_SEMICOLON,
    HID_KEYBOARD_HU_ACUTE_I = HID_KEYBOARD_NONUS_BACKSLASH,
    HID_KEYBOARD_HU_COMMA = HID_KEYBOARD_COLON,
    HID_KEYBOARD_HU_DASH = HID_KEYBOARD_SLASH,
    HID_KEYBOARD_HU_DOT = HID_KEYBOARD_DOT,
};

/** ASCII to keycode conversion table HU */
static const uint16_t hid_asciimap_hu[] = {
    ...
    HID_KEYBOARD_NONE, // EM
    HID_KEYBOARD_NONE, // SUB
    HID_KEYBOARD_ESCAPE, // ESC
    HID_KEYBOARD_NONE, // FS
    HID_KEYBOARD_NONE, // GS
    HID_KEYBOARD_NONE, // RS
    HID_KEYBOARD_NONE, // US
    HID_KEYBOARD_SPACEBAR, // ' ' Space
    HID_KEYBOARD_HU_4 | KEY_MOD_LEFT_SHIFT, // !
    HID_KEYBOARD_HU_2 | KEY_MOD_LEFT_SHIFT, // "
    HID_KEYBOARD_HU_X | KEY_MOD_RIGHT_ALT, // #
    HID_KEYBOARD_HU_ACCENT_E | KEY_MOD_RIGHT_ALT, // $
    HID_KEYBOARD_HU_5 | KEY_MOD_LEFT_SHIFT, // %
    HID_KEYBOARD_HU_C | KEY_MOD_RIGHT_ALT, // &
    HID_KEYBOARD_HU_1 | KEY_MOD_LEFT_SHIFT, // '
    HID_KEYBOARD_HU_8 | KEY_MOD_LEFT_SHIFT, // (
    HID_KEYBOARD_HU_9 | KEY_MOD_LEFT_SHIFT, // )
    HID_KEYBOARD_HU_DASH | KEY_MOD_RIGHT_ALT, // *
    ...
    HID_KEYBOARD_HU_8, // 8
    HID_KEYBOARD_HU_9, // 9
    HID_KEYBOARD_HU_DOT | KEY_MOD_LEFT_SHIFT, // :
    HID_KEYBOARD_HU_COMMA | KEY_MOD_RIGHT_ALT, // ;
    HID_KEYBOARD_HU_ACUTE_I | KEY_MOD_RIGHT_ALT, // <
    HID_KEYBOARD_HU_7 | KEY_MOD_LEFT_SHIFT, // =
    HID_KEYBOARD_HU_Y | KEY_MOD_RIGHT_ALT, // >
    HID_KEYBOARD_HU_COMMA | KEY_MOD_LEFT_SHIFT, // ?
    ...
    HID_KEYBOARD_HU_3 | KEY_MOD_RIGHT_ALT, // ^
    HID_KEYBOARD_HU_DASH | KEY_MOD_LEFT_SHIFT, // _
    HID_KEYBOARD_HU_7 | KEY_MOD_RIGHT_ALT, // `
    HID_KEYBOARD_HU_A, // a
    HID_KEYBOARD_HU_B, // b
    HID_KEYBOARD_HU_C, // c
    HID_KEYBOARD_HU_D, // d
    ...
    HID_KEYBOARD_HU_1 | KEY_MOD_RIGHT_ALT, // ~
    HID_KEYBOARD_NONE, // DEL
};

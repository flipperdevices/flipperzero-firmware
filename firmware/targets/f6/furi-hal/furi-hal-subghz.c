...
void furi_hal_subghz_init() {
    ...
    furi_hal_spi_acquire(&furi_hal_spi_config_subghz);
    ...
    cc1101_reset(&furi_hal_spi_config_subghz);
    cc1101_write_reg(&furi_hal_spi_config_subghz, CC1101_IOCFG0, CC1101IocfgHighImpedance);

    // Prepare GD0 for power on self test
    hal_gpio_init(&gpio_cc1101_g0, GpioModeInput, GpioPullNo, GpioSpeedLow);

    // GD0 low
    cc1101_write_reg(&furi_hal_spi_config_subghz, CC1101_IOCFG0, CC1101IocfgHW);
    while(hal_gpio_read(&gpio_cc1101_g0) != false)
        ;

    // GD0 high
    cc1101_write_reg(&furi_hal_spi_config_subghz, CC1101_IOCFG0, CC1101IocfgHW | CC1101_IOCFG_INV);
    ...
    cc1101_write_reg(&furi_hal_spi_config_subghz, CC1101_IOCFG2, CC1101IocfgHW);

    // Go to sleep
    cc1101_shutdown(&furi_hal_spi_config_subghz);

    furi_hal_spi_release(&furi_hal_spi_config_subghz);
...
void furi_hal_subghz_sleep() {
    ...
    cc1101_switch_to_idle(&furi_hal_spi_config_subghz);
...
void furi_hal_subghz_dump_state() {
    ...
    printf(
        ...
        cc1101_get_partnumber(&furi_hal_spi_config_subghz),
        cc1101_get_version(&furi_hal_spi_config_subghz));
    furi_hal_spi_release(&furi_hal_spi_config_subghz);
}
...
void furi_hal_subghz_load_registers(const uint8_t data[][2]) {
    ...
    uint32_t i = 0;
    while(data[i][0]) {
        cc1101_write_reg(&furi_hal_spi_config_subghz, data[i][0], data[i][1]);
        i++;
    }
    furi_hal_spi_release(&furi_hal_spi_config_subghz);
}
...
void furi_hal_subghz_load_patable(const uint8_t data[8]) {
    furi_hal_spi_acquire(&furi_hal_spi_config_subghz);
    cc1101_set_pa_table(&furi_hal_spi_config_subghz, data);
    furi_hal_spi_release(&furi_hal_spi_config_subghz);
}

void furi_hal_subghz_write_packet(const uint8_t* data, uint8_t size) {
    furi_hal_spi_acquire(&furi_hal_spi_config_subghz);
    cc1101_flush_tx(&furi_hal_spi_config_subghz);
    cc1101_write_fifo(&furi_hal_spi_config_subghz, data, size);
    furi_hal_spi_release(&furi_hal_spi_config_subghz);
}

void furi_hal_subghz_flush_rx() {
    furi_hal_spi_acquire(&furi_hal_spi_config_subghz);
    cc1101_flush_rx(&furi_hal_spi_config_subghz);
    furi_hal_spi_release(&furi_hal_spi_config_subghz);
}

void furi_hal_subghz_read_packet(uint8_t* data, uint8_t* size) {
    furi_hal_spi_acquire(&furi_hal_spi_config_subghz);
    cc1101_read_fifo(&furi_hal_spi_config_subghz, data, size);
    furi_hal_spi_release(&furi_hal_spi_config_subghz);
}
...
void furi_hal_subghz_rx() {
    furi_hal_spi_acquire(&furi_hal_spi_config_subghz);
    cc1101_switch_to_rx(&furi_hal_spi_config_subghz);
    furi_hal_spi_release(&furi_hal_spi_config_subghz);
}
...
bool furi_hal_subghz_tx() {
    ...
    furi_hal_spi_acquire(&furi_hal_spi_config_subghz);
    cc1101_switch_to_tx(&furi_hal_spi_config_subghz);
    furi_hal_spi_release(&furi_hal_spi_config_subghz);
    return true;
}
...
float furi_hal_subghz_get_rssi() {
    furi_hal_spi_acquire(&furi_hal_spi_config_subghz);
    int32_t rssi_dec = cc1101_get_rssi(&furi_hal_spi_config_subghz);
    furi_hal_spi_release(&furi_hal_spi_config_subghz);
...
uint32_t furi_hal_subghz_set_frequency(uint32_t value) {
    ...
    uint32_t real_frequency = cc1101_set_frequency(&furi_hal_spi_config_subghz, value);
    cc1101_calibrate(&furi_hal_spi_config_subghz);

    while(true) {
        CC1101Status status = cc1101_get_status(&furi_hal_spi_config_subghz);
...
void furi_hal_subghz_set_path(FuriHalSubGhzPath path) {
    ...
    if(path == FuriHalSubGhzPath433) {
        ...
        cc1101_write_reg(&furi_hal_spi_config_subghz, CC1101_IOCFG2, CC1101IocfgHW | CC1101_IOCFG_INV);
